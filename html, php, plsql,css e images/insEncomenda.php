...
<div id="header">
  ...
  <div id="menu">
    <ul id="main">
		...
		<li><a href="procurar.html">Procurar Livro</a></li>
	    <li><a href="procurarA.html">Procurar Autor </a></li>
		<li class="current_page_item"><a href="encomendar.html">Encomendar</a></li>
...
<?php
  ...
  $stmt = oci_parse ($conn, "begin P_ENTREGAS.ins(:p_liv_nome,:p_uti_id_f,:error,:errorMsg); end;");
  oci_bind_by_name($stmt,":p_liv_nome",$_REQUEST["p_liv_nome"]);
  oci_bind_by_name($stmt,":p_uti_id_f",$_REQUEST["p_uti_id_f"]);
  ...
  if ($error != 0) {
    ...
    echo "<h2 class=\"sucesso\">Encomenda realizada com sucesso!";
  }
